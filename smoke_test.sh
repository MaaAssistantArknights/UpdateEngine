...
RUN_SMOKE_TEST="dotnet run --project MaaUpdateEngine.SmokeTest --"
...
$RUN_SMOKE_TEST test/long_workdir test/smoke_test_input_long.json test/long_package file://./output/MAA-v5.4.2-alpha.1.d104.g2428a4610-win-x64-delta.tar.zst
...
$RUN_SMOKE_TEST test/short_workdir test/smoke_test_input_short.json test/short_package file://./output/MAA-v5.4.2-alpha.1.d104.g2428a4610-win-x64-delta.tar.zst
...
pid=$!
echo '{"name":"MAA","version":"v5.4.1-alpha.1.d090.g73458d38c","variant":"win-x64"}' > test/smoke_test_input_short.json
$RUN_SMOKE_TEST test/running_workdir test/smoke_test_input_short.json test/running_package file://./output/MAA-v5.4.2-alpha.1.d104.g2428a4610-win-x64-delta.tar.zst
kill $pid
